...
%>
	...
	<form action="updateServiceForm.jsp" method="post">
		<table class="center">
			<tr>
				<td>Id:</td>
				<td><input type="text" name="serviceId"
					value="<%= serviceId %>" readonly /></td>
			</tr>
			<tr>
				<td>Service Name:</td>
			...
			<tr>
				...
				<td><textarea name="serviceDescription" rows="4" cols="50"><%= serviceDescription %></textarea>
				</td>
			</tr>
			<tr>
				<td>Image URL:</td>
			...
			<tr>
				...
				<td><input type="text" name="serviceCategoryId"
					value="<%= serviceCategoryId %>" /></td>
			</tr>
			<tr>
